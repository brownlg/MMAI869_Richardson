...
def arg_parse():
    ...
    parser.add_argument("--confidence", dest = "confidence", help = "Object Confidence to filter predictions", default = 0.99)
...
#        scale_indices = li
    ...
    num_classes = 1
    classes = load_classes('data/coco - Copy.names')
...
#        print(end - start)
        ...
        for im_num, image in enumerate(imlist[i*batch_size: min((i +  1)*batch_size, len(imlist))]):
            ...
            print("{} {}".format("Number of people Detected:", count_people(objs)))
            print("----------------------------------------------------------")
        i += 1
    ...
    list(map(lambda x: write(x, im_batches, orig_ims,colors,classes), output))
