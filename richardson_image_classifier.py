...
import richardson_file_handlers
...
x_train = richardson_file_handlers.load_images_for_keras(my_paths.TRAIN_PATH)
x_test = richardson_file_handlers.load_images_for_keras(my_paths.TEST_PATH)
...
input_shape = (WINDOW_X, WINDOW_Y, 3)
...
model.add(Dense(128 * 4, activation=tf.nn.relu))
